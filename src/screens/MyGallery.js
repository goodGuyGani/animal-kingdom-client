...
function MyGallery() {
  ...
  useEffect(() => {
    Axios.get(
      `https://graceful-nightgown-wasp.cyclic.app/api/getgallery/${userid}`
    ).then((response) => {
    ...
    <>
      ...
      <center>
        <h2 className="head-text">
          My Gallery<span style={{ color: "#4c7031" }}></span>
        </h2>
      </center>
            ...
            <div class="cards-inner">
              <div style={{ marginLeft: 10 }}>
                <>
                  ...
                  <center>
                    <img
                      src={`https://graceful-nightgown-wasp.cyclic.app/api/images/${val.imgName}`}
                      alt=""
                      style={{
                        height: 260,
                        width: 260,
                  ...
                  <span style={{ fontSize: 14, color: "#46364a" }}>
                    Identified At: {val.dateIdentified}
                  </span>
                </>
              </div>
            </div>
