...
function QuizResult() {
  ...
  useEffect(() => {
    Axios.get(
      `https://graceful-nightgown-wasp.cyclic.app/api/getlesson/${lessonid}`
    ).then((response) => {
  ...
  useEffect(() => {
    Axios.get(
      `https://graceful-nightgown-wasp.cyclic.app/api/checkanswers/${userid}/${lessonid}`
    ).then((response) => {
  ...
  const retry = () => {
    Axios.delete(
      `https://graceful-nightgown-wasp.cyclic.app/api/deleteanswers/${userid}/${lessonid}`
    );
  };
  ...
  const download = () => {
    Axios.get(
      `https://graceful-nightgown-wasp.cyclic.app/api/createcerf/${userid}/${lessonid}/${myName}/${lessonName}`
    ).then((response) => {});

    Axios.get(
      `https://graceful-nightgown-wasp.cyclic.app/api/getcerf/${myName}/${lessonName}`
    ).then((response) => {});
  };
        ...
        <div className="App2">
          <div class="quiz-container" id="quiz">
            <div class="quiz-header">
              ...
              <h1 style={{ fontWeight: "bold" }}>
                You got {correctCount} out 10 right!
              </h1>
              <button
                className="next3"
            ...
            <button
              ...
              onClick={() => {
                finlesson();
                navigate(`/scorepage/${myId}/${myName}`);
              }}
            >
              Finish Lesson
            </button>
