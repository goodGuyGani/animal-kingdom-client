        ...
        {dog.map((item) => (
          ...
          >
            ...
            <article>
              ...
              {item.description && (
                <p className="text-slate-700 mb-8 text-sm lg:text-base leading-loose lg:leading-relax">
                  {item.description}
                </p>
              )}
              ...
              <Link
                to="/cats"
                className="inline-block bg-slate-400 py-2 px-6 rounded mt-8 hover:bg-slate-500 
